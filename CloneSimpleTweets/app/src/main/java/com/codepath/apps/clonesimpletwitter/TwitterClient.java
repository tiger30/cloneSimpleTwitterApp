...
public class TwitterClient extends OAuthBaseClient {
    ...
    public static final String REST_CONSUMER_KEY = "teAHiWJyMu8PZAcpzNEkQeUbY";
	public static final String REST_CONSUMER_SECRET = "HYBl7nZHDr7LtKSWa3yROaq56sOUgYRPOJYKJ5Jtyu67Dg0Zqs";
	public static final String REST_CALLBACK_URL = "oauth://CloneSimpleTwitterApp"; // Change this (here and in manifest)
